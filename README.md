...
| [`templates/`](templates/) | Metadata and document templates |
| [`tutorials/`](tutorials/) | Learning material |
| [`software/`](software/) | Recommended software |
| [`workflows/`](workflows/) | Example workflows |
| [`datasets/`](datasets/) | Example datasets |
| [`links/`](links/) | Useful external resources |
...
Researchers are welcome to contribute improvements! Please see [`CONTRIBUTING.md`](CONTRIBUTING.md) for details on how to get started.
